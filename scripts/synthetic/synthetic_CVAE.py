...
dirname = os.path.join(ROOTDIR, 'results', 'CVAE', ratname, 'batch' + str(perm_ind))
...
n_params.update({'n_recog': [50, 50, 50, 50], 'n_scale': [50, 50, 50, 50], 'n_gener_z': [50, 50, 50, 50], 'n_gener_kappa': [50, 50, 50, 50],
                 'n_recog_y': [50, 50, 50, 50], 'n_gener_y': [50, 50, 50, 50], 'n_recog_kappa': [50, 50, 50, 50],
                 'n_z': 10, 'n_x': 10})

n_params.update({'n_batch': n_batch})
n_params.update({'alpha_1': alpha_1})
