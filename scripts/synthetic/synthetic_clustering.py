...
for ratname in ratnames:
    ...
    for l in range(10):
        ...
        data = np.load(os.path.join(ROOTDIR, 'SPIKE_data', ratname, 'data' + str(l) + '.npy'), allow_pickle=True)[()]
        ...
        np.save(os.path.join(ROOTDIR, 'SPIKE_data', ratname, 'clu' + str(l) + '.npy'), clus)
